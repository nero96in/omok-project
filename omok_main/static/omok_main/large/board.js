...
JGO.BOARD.large = {
    textures: {
        black: '/static/omok_main/large/black.png',
        white: '/static/omok_main/large/white.png',
        shadow:'/static/omok_main/large/shadow.png',
        board: '/static/omok_main/large/shinkaya.jpg'
    },
...
JGO.BOARD.largeWalnut = JGO.util.extend(JGO.util.extend({}, JGO.BOARD.large), {
    textures: {board: '/static/omok_main/large/walnut.jpg', shadow: '/static/omok_main/large/shadow_dark.png'},
